...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = LAYOUT_split_3x5_3(
       ...
       KC_A, KC_S, KC_D, LSFT_T(KC_F), KC_G, KC_H, RSFT_T(KC_J), KC_K, KC_L, KC_QUOT,
       PT_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, PT_SLSH,
                      KC_ESC, KC_TAB, KC_SPC, KC_ENT, KC_BSPC, KC_MUTE
  ),
 ...
 */
  [LAYER_MEDIA] = LAYOUT_split_3x5_3(
    XXXXXXX,RM_PREV, RGB_TOG, RM_NEXT, XXXXXXX, XXXXXXX,RM_PREV, RGB_TOG, RM_NEXT, XXXXXXX,
